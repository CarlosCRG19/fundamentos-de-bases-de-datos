...
typedef struct _PreparedStatements {
    ...
    SQLHSTMT booking_check; /* checks if a booking exists with a given book_ref */
    SQLHSTMT created_boarding_passes; /* queries the boarding passes that were just assigned */
} _PreparedStatements;
